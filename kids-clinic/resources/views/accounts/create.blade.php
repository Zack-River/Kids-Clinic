...
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0">إضافة معاملة</h4>
            ...
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('accounts.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" required placeholder="أدخل بيان المعاملة">
                        @error('title')
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" min="0" class="form-control @error('amount') is-invalid @enderror" id="amount" name="amount" value="{{ old('amount') }}" required placeholder="0.00" dir="ltr">
                            @error('amount')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-5">
                        ...
                        <button type="submit" class="btn btn-primary-custom px-5">حفظ المعاملة</button>
                    </div>
                </form>
            </div>
        </div>
