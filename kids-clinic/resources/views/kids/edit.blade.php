...
<div class="d-flex align-items-center justify-content-between mb-4">
    <h4 class="fw-bold mb-0">تعديل ملف الطفل</h4>
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">تعديل طفل</li>
        </ol>
    </nav>
</div>
    ...
    <div class="col-12 col-xl-10">
        <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('kids.update', $kid) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row g-4">
                        <!-- Child Name -->
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0 @error('full_name') is-invalid @enderror" id="full_name" name="full_name" value="{{ old('full_name', $kid->full_name) }}" placeholder="أدخل اسم الطفل رباعي" required minlength="3" pattern="^[\u0621-\u064Aa-zA-Z\s]+$" oninvalid="this.setCustomValidity('يرجى إدخال اسم صحيح (3 أحرف على الأقل، أحرف فقط)')" oninput="this.setCustomValidity('')">
                                @error('full_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control border-start-0 ps-0 @error('parent_name') is-invalid @enderror" id="parent_name" name="parent_name" value="{{ old('parent_name', $kid->parent_name) }}" placeholder="اسم ولي الأمر" minlength="3" pattern="^[\u0621-\u064Aa-zA-Z\s]+$" oninvalid="this.setCustomValidity('يرجى إدخال اسم صحيح (أحرف فقط)')" oninput="this.setCustomValidity('')">
                                @error('parent_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="w-100 position-relative">
                                <input type="tel" dir="ltr" style="text-align: right !important;" class="form-control @error('contact_phone') is-invalid @enderror" id="contact_phone" name="contact_phone" value="{{ old('contact_phone', $kid->contact_phone) }}">
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-4 mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="genderMale" value="Male" {{ old('gender', $kid->gender) == 'Male' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="genderMale">
                                        ذكر
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="genderFemale" value="Female" {{ old('gender', $kid->gender) == 'Female' ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control bg-white border-start-0 ps-0 @error('date_of_birth') is-invalid @enderror" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $kid->date_of_birth) }}" placeholder="اختر تاريخ الميلاد" required oninvalid="this.setCustomValidity('تاريخ الميلاد مطلوب')" oninput="this.setCustomValidity('')">
                                @error('date_of_birth')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
